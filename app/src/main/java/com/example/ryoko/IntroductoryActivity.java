...
public class IntroductoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bg.animate().translationY(-2200).setDuration(1000).setStartDelay(4000);
        logo.animate().translationY(1800).setDuration(1000).setStartDelay(4000);
        name.animate().translationY(1800).setDuration(1000).setStartDelay(4000);
        slogan.animate().translationY(1800).setDuration(1000).setStartDelay(4000);
